...
pub static LC_MAP: LazyLock<HashMap<&'static str, (&'static str, &'static str)>> = LazyLock::new(|| {
    ...
    m.insert("F001", ("US Local History", "New England"));
    m.insert("F1001", ("North American History", "Canada"));
    m.insert("F106", ("US Local History", "Atlantic & Middle Atlantic States"));
    m.insert("F1201", ("North American History", "Mexico"));
    m.insert("F1401", ("Latin American History", "General"));
    m.insert("F1461", ("Latin American History", "Guatemala"));
    m.insert("F1481", ("Latin American History", "El Salvador"));
    m.insert("F1501", ("Latin American History", "Honduras"));
    m.insert("F1521", ("Latin American History", "Nicaragua"));
    m.insert("F1541", ("Latin American History", "Costa Rica"));
    m.insert("F1561", ("Latin American History", "Panama"));
    m.insert("F1601", ("Americas History", "West Indies"));
    m.insert("F1751", ("Americas History", "West Indies. Cuba"));
    m.insert("F1861", ("Americas History", "West Indies. Jamaica"));
    m.insert("F1900", ("West Indies History", "Hispaniola"));
    m.insert("F1951", ("West Indies History", "Puerto Rico"));
    m.insert("F2001", ("Americas History", "Lesser Antilles"));
    m.insert("F206", ("US Local History", "South Atlantic States"));
    m.insert("F2131", ("Americas History", "West Indies. British West Indies"));
    m.insert("F2155", ("Americas History", "Caribbean area. Caribbean sea"));
    m.insert("F2201", ("Latin American History", "South America. General"));
    m.insert("F2251", ("Latin American History", "Colombia"));
    m.insert("F2301", ("Latin American History", "Venezuela"));
    m.insert("F2351", ("Latin American History", "Guyana"));
    m.insert("F2501", ("Latin American History", "Brazil"));
    m.insert("F2661", ("Latin American History", "Paraguay"));
    m.insert("F2701", ("Latin American History", "Uruguay"));
    m.insert("F2801", ("Latin American History", "Argentina"));
    m.insert("F296", ("US Local History", "Gulf States. West Florida"));
    m.insert("F3051", ("Latin American History", "Chile"));
    m.insert("F3301", ("Latin American History", "Bolivia"));
    m.insert("F3401", ("Latin American History", "Peru"));
    m.insert("F350.5", ("US Local History", "Mississippi Valley, Middle West"));
    m.insert("F3701", ("Latin American History", "Ecuador"));
    m.insert("F396", ("US Local History", "Old Southwest, Lower Mississippi"));
    m.insert("F476", ("US Local History", "Old Northwest, Northwest Territory"));
    m.insert("F516", ("US Local History", "Ohio River Valley"));
    m.insert("F590.3", ("US Local History", "Trans-Mississippi, Great Plains"));
    m.insert("F721", ("US Local History", "Rocky Mountains, Yellowstone"));
    m.insert("F786", ("US Local History", "New Southwest, Colorado River Valley"));
    m.insert("F850.5", ("US Local History", "Pacific States"));
    m.insert("F975", ("US Local History", "US-Protected Territories"));
